...
acc('body').append('<div id="msaa_message" role="button" tabindex="0" aria-live="polite">请用争渡读屏监视这个按钮(消息)</div><div id="msaa_gift" role="button" tabindex="0" aria-live="polite">请用争渡读屏监视这个按钮(礼物)</div><div id="msaa_barrage" role="button" tabindex="0" aria-live="polite">请用争渡读屏监视这个按钮(弹幕)</div>');
